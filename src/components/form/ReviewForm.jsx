    ...
    return (
        <div className="review_form">
            ...
            <div className="form_control">
                ...
                <textarea name="comment" id="comment" placeholder='Conte como foi sua experiência com o produto' value={data.comment || ''} onChange={(e) => { updateFieldHandler('comment', e.target.value) }}></textarea>
            </div>
        </div>
    )
}
